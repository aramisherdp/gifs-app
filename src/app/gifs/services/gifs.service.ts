...
export class GifsService {
  ...
  private apiKey: string = 'skV2zlnhuMpnugk2Srj7GkcRfCd4QM2x';
  ...
  async searchTag(tag: string):Promise<void> {
    ...
    // fetch('http://api.giphy.com/v1/gifs/search?api_key=skV2zlnhuMpnugk2Srj7GkcRfCd4QM2x&q=valorant&limit=10')
    //   .then(resp => resp.json())
